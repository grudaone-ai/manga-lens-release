...
async function loadConfig() {
  ...
  if (zhipuApiKeyInput) zhipuApiKeyInput.value = result.zhipuApiKey || '';
  if (zhipuVisionModelInput) zhipuVisionModelInput.value = result.zhipuVisionModel || result.zhipuTranslationModel || 'glm-4.6v';
  if (toggleEnabled) toggleEnabled.checked = result.isEnabled !== false;
}
