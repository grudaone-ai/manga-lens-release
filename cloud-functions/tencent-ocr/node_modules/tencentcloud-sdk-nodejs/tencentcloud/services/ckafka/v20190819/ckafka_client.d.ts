...
export declare class Client extends AbstractClient {
     ...
     * 修改实例公网IP白名单列表接口
     */
    ModifyAccessPolicy(req: ModifyAccessPolicyRequest, cb?: (error: string, rep: ModifyAccessPolicyResponse) => void): Promise<ModifyAccessPolicyResponse>;
    /**
     * 修改连接器任务
     */
...
本接口（DescribeTopic）用于在用户获取消息队列 CKafka 实例的主题列表
     ...
     * 查询实例公网IP白名单列表接口
     */
    DescribeAccessPolicy(req: DescribeAccessPolicyRequest, cb?: (error: string, rep: DescribeAccessPolicyResponse) => void): Promise<DescribeAccessPolicyResponse>;
    /**
     * 获取主题列表详情（仅控制台调用）
     */
